...
const HowItWorks = () => {
  ...
  return <section id="how-it-works" className="container-section">
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        ...
        <div className="p-6">
          {activeStep === 1 && <WalletConnect currentStep={activeStep} loading={loading} selectedWallet={selectedWallet} connectWallet={connectWallet} error={error} onComplete={() => setActiveStep(2)} />}
          
          {activeStep === 2 && <ConvertCurrency isConnected={isConnected} selectedWallet={selectedWallet} eurAmount={eurAmount} setEurAmount={setEurAmount} vaiotTokens={vaiotTokens} prices={prices} onPrevStep={() => setActiveStep(1)} onNextStep={() => setActiveStep(3)} setIsConnected={setIsConnected} />}
          
          {activeStep === 3 && <CompleteTransaction ethAmount={ethAmount} prices={prices} onPrevStep={() => setActiveStep(2)} />}
        </div>
      </div>
